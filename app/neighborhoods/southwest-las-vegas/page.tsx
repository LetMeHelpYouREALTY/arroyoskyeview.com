          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <section className="mb-12">
                <h2 className="text-3xl font-bold text-foreground mb-6">About Southwest Las Vegas, Nevada</h2>
              ...
              <section className="mb-12">
                <h2 className="text-3xl font-bold text-foreground mb-6">Why Choose New Construction in Southwest Las Vegas?</h2>
              ...
              <section className="mb-12">
                <h2 className="text-3xl font-bold text-foreground mb-6">Expert Buyer Representation for Southwest Las Vegas</h2>
                <p className="text-lg text-muted-foreground mb-4">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-muted rounded-lg p-6 mt-8">
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <Link href="/neighborhoods/henderson-las-vegas" className="text-primary hover:text-primary underline">
