...
const resources = [
  ...
  {
    title: 'New Construction Inspections Guide',
    description: 'Full timeline for Arroyo at Skyeview and Skye Canyon 89166: construction monitoring, pre-drywall, closing inspection, and walkthrough.',
