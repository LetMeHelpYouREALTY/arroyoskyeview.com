  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <section className="mb-12">
        ...
        <p className="text-lg text-muted-foreground mb-4">
          Arroyo at Skyeview offers three thoughtfully designed floor plans ranging from 1,531 to 1,729 square feet. Each home features modern open-concept layouts, quartz countertops, energy-efficient appliances, and contemporary design elements. With 2-4 bedrooms, 2.5 bathrooms, and 2-bay garages, these townhomes provide 1,531 to 1,729 square feet with 2-4 bedrooms in northwest Las Vegas, Nevada (zip code 89166).
        </p>
      ...
      <section className="mb-12">
        ...
        <p className="text-lg text-muted-foreground mb-4">
          Skye Canyon is a 1,700-acre master-planned community in northwest Las Vegas that represents one of the city's most thoughtfully designed residential developments. The community is designed for active lifestyles with extensive amenities including parks, trails, recreation centers, and neighborhood schools including Roger Bryan Elementary. Skye Canyon combines the natural beauty of the surrounding desert landscape with modern community planning.
        </p>
