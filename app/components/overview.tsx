    ...
    <div>
      ...
      <div className="mb-8 max-w-none">
        <p className="mb-6 text-lg leading-relaxed text-muted-foreground">
          ...
          . These thoughtfully designed two-story townhomes feature quartz countertops, open layouts, 2 to 4 bedrooms, 2.5 baths, and 2-bay garages. As part of the 1,700-acre Skye Canyon master-planned community, Arroyo at Skyeview Homes residents enjoy resort-style pool, fitness center, parks, trails, and Roger Bryan Elementary. Located near US-95 and the 215 Beltway, this northwest Las Vegas community provides easy access to employment centers, shopping, and outdoor recreation. When buying Arroyo at Skyeview Homes, work with{' '}
