        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-muted rounded-lg p-8 mb-8">
              <h3 className="text-xl font-bold text-foreground mb-4 text-center">Inventory Growth by Region</h3>
            ...
            <div className="bg-muted rounded-lg p-8 mb-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="bg-green-100 rounded-lg p-4">
                  <h4 className="font-bold text-foreground mb-2">Fully Recovered</h4>
                  <p className="text-sm text-muted-foreground">South and West regions have inventory above pre-pandemic levels</p>
                </div>
                <div className="bg-yellow-100 rounded-lg p-4">
                  <h4 className="font-bold text-foreground mb-2">Still Recovering</h4>
                  <p className="text-sm text-muted-foreground">Northeast and Midwest inventory is below pre-pandemic levels but improving</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-50 border-l-4 border-green-600 p-6 mb-8 rounded-r-lg">
              <h3 className="text-xl font-bold text-foreground mb-2">And here's why that's still a win everywhere.</h3>
              <p className="text-lg text-foreground">
